...
var G__12916 = devtools.prefs.pref(v);
v = G__12916;
continue;
} else {
return v;
...
}catch (e12872){var _e__11472__auto__ = e12872;
return false;
}})();
...
}catch (e12876){var _e__11472__auto__ = e12876;
return false;
}})();
...
}catch (e12880){var _e__11472__auto__ = e12880;
return false;
}}
}
});
...
var vec__12898 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12898,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12898,(1),null);
...
return cljs.core.some((function (p1__12902_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12902_SHARP_);
}),template);
});
