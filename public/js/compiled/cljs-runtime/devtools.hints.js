...
var reader = (function (){var or__5045__auto__ = devtools.prefs.pref(new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__5045__auto__ = devtools.prefs.pref(new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return (128);
...
var map__12913 = top_item;
var map__12913__$1 = cljs.core.__destructure_map(map__12913);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12913__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12913__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12913__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e12908){var _e = e12908;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___12935 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___12935)){
var seen_errors_12936 = temp__5802__auto___12935;
if(cljs.core.truth_(seen_errors_12936.has(self))){
} else {
seen_errors_12936.add(self);

var temp__5804__auto___12937 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___12937)){
var sense_12938 = temp__5804__auto___12937;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_12938)].join(''));
} else {
}
}
} else {
