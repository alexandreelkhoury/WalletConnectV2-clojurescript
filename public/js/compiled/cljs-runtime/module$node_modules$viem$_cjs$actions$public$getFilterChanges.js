...
filter&&filter.strict)return;eventName=err.abiItem.name;isUnnamed=err.abiItem.inputs?.some(x=>!("name"in x&&x.name))}return(0,log_js_1.formatLog)(log,{args:isUnnamed?[]:{},eventName})}}).filter(Boolean)}}
//# sourceMappingURL=module$node_modules$viem$_cjs$actions$public$getFilterChanges.js.map
