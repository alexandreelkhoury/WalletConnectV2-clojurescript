...
var len__5769__auto___12992 = arguments.length;
var i__5770__auto___12993 = (0);
while(true){
if((i__5770__auto___12993 < len__5769__auto___12992)){
args__5775__auto__.push((arguments[i__5770__auto___12993]));

var G__12995 = (i__5770__auto___12993 + (1));
i__5770__auto___12993 = G__12995;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12925){
var G__12926 = cljs.core.first(seq12925);
var seq12925__$1 = cljs.core.next(seq12925);
var G__12927 = cljs.core.first(seq12925__$1);
var seq12925__$2 = cljs.core.next(seq12925__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12926,G__12927,seq12925__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12954_SHARP_){
return (!((cljs.core.meta(p1__12954_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12973__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12974){var _e__11472__auto__ = e12974;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e12977){var _e__11472__auto__ = e12977;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12981 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12982 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12982);

try{var map__12983 = opts;
var map__12983__$1 = cljs.core.__destructure_map(map__12983);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12983__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12981);
}});
...
var temp__5802__auto___13020 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___13020)){
var managed_print_level_13021 = temp__5802__auto___13020;
var _STAR_print_level_STAR__orig_val__12986_13022 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12987_13023 = managed_print_level_13021;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12987_13023);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__12984_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__12984_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12986_13022);
}} else {
job_fn();
}
