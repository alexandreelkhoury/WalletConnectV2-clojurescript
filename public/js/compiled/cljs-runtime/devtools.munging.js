...
var temp__5802__auto____$1 = (o11908["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o11909 = temp__5802__auto____$1;
return (o11909["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11445__auto__ = f;
return (o__11445__auto__["toString"]).call(o__11445__auto__);
} else {
return "";
}
}catch (e11926){var _ = e11926;
return "";
}});
...
try{var o__11445__auto___12624 = t;
(o__11445__auto___12624["cljs$lang$ctorPrWriter"]).call(o__11445__auto___12624,t,writer);
}catch (e11965){var __12625 = e11965;
}
...
var char_code = (function (){var o__11445__auto__ = (new String(char$));
return (o__11445__auto__["charCodeAt"]).call(o__11445__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11445__auto__ = String;
return (o__11445__auto__["fromCharCode"]).call(o__11445__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12021 = num_code;
switch (G__12021) {
case (1):
return (185);
...
var o__11445__auto__ = String;
return (o__11445__auto__["fromCharCode"]).call(o__11445__auto__,superscript_code);
});
/**
...
}catch (e12079){var _e__11472__auto__ = e12079;
return false;
}})())){
...
var vec__12081 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12081,(0),null);
...
var or__5045__auto__ = (function (){var temp__5802__auto__ = cljs.core.re_matches(/(.*)\$/,s);
if(cljs.core.truth_(temp__5802__auto__)){
...
if(cljs.core.truth_(temp__5802__auto__)){
var o12117 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12117["dependencies_"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12118 = temp__5802__auto____$1;
return (o12118["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12148){
var vec__12149 = p__12148;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12149,(0),null);
var effective_detector = (function (){var or__5045__auto__ = ns_detector;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
var G__12656 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__12657 = cljs.core.butlast(remaining_tokens);
name_tokens = G__12656;
remaining_tokens = G__12657;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12133){
...
var vec__12180 = cljs.core.split_with((function (p1__12176_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12176_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12180,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12180,(1),null);
...
var vec__12200 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12200,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12200,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__12662 = cljs.core.rest(remaining_tokens);
var G__12663 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__12662;
name_tokens = G__12663;
continue;
} else {
...
var vec__12216 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12216,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12216,(1),null);
var vec__12219 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12219,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12219,(1),null);
var vec__12222 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12222,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12222,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12222,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12222,(3),null);
...
var vec__12254 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12254,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12254,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12254,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12254,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12254,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12254,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12268 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12268,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12268,(1),null);
var vec__12272 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12272,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12272,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12282 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12282) : devtools.munging.parse_fn_info_deep.call(null,G__12282));
})()));
}
} else {
return fn_info;
...
var G__12701 = (arity + (1));
var G__12702 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12331){
var vec__12332 = p__12331;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12332,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12332,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities(f,(function (){var or__5045__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12370_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12370_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12371_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12371_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___12713 = arguments.length;
var i__5770__auto___12714 = (0);
while(true){
if((i__5770__auto___12714 < len__5769__auto___12713)){
args__5775__auto__.push((arguments[i__5770__auto___12714]));

var G__12716 = (i__5770__auto___12714 + (1));
i__5770__auto___12714 = G__12716;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12399){
var vec__12402 = p__12399;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12402,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12387){
var G__12388 = cljs.core.first(seq12387);
var seq12387__$1 = cljs.core.next(seq12387);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12388,seq12387__$1);
}));
...
return devtools.munging.args_lists_to_strings(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((function (){var or__5045__auto__ = devtools.munging.collect_fn_arities(f);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
return [(cljs.core.truth_((function (){var and__5043__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),(((!(cljs.core.empty_QMARK_(protocol_name))))?[(cljs.core.truth_(include_protocol_ns_QMARK_)?".":null),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null),(((!(cljs.core.empty_QMARK_(protocol_method))))?[(cljs.core.truth_((function (){var or__5045__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
var map__12449 = options;
var map__12449__$1 = cljs.core.__destructure_map(map__12449);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12449__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12449__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12449__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12449__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12450 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12450,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12450,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12450,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12450,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12450,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12450,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__5043__auto__ = protocol_ns;
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core.not((function (){var and__5043__auto____$1 = silence_common_protocols_QMARK_;
...
return [(function (){var or__5045__auto__ = protocol_part;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return fn_part;
...
var o__11445__auto__ = f;
return (o__11445__auto__["getBasis"]).call(o__11445__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__5043__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__5043__auto__)){
...
}catch (e12460){var _e__11472__auto__ = e12460;
...
var G__12750 = (obj[cljs.core.first(path)]);
var G__12751 = cljs.core.rest(path);
obj = G__12750;
path = G__12751;
continue;
} else {
...
var partition_bits = (function (){var or__5045__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return (0);
...
var _STAR_ = (function (accum,p__12501){
var vec__12502 = p__12501;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12502,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12502,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12564){
var vec__12568 = p__12564;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12568,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12568,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12568,(2),null);
...
var post_process = (function (p__12602){
var vec__12604 = p__12602;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12604,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12604,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12588_SHARP_){
return (obj[cljs.core.first(p1__12588_SHARP_)]);
}),sorted_matches);
