...
var _STAR_print_newline_STAR__orig_val__16150_16296 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__16151_16297 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__16152_16298 = true;
var _STAR_print_fn_STAR__temp_val__16153_16299 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__16152_16298);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__16153_16299);

try{var _STAR_print_level_STAR__orig_val__16156_16300 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__16157_16301 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__16157_16301);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__16156_16300);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__16151_16297);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__16150_16296);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq16141){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq16141));
}));
...
var new_formatters = current_formatters.filter((function (p1__16190_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__16190_SHARP_)));
}));
...
var G__16198_16346 = f;
var target__11462__auto___16347 = G__16198_16346;
if(cljs.core.truth_(target__11462__auto___16347)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__16198_16346)].join(''),"\n","target__11462__auto__"].join('')));
}

(target__11462__auto___16347["toString"] = (function (){
...
var G__16203_16348 = "%c%s";
var G__16204_16349 = "color:transparent";
var G__16205_16350 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__16203_16348,G__16204_16349,G__16205_16350) : f.call(null,G__16203_16348,G__16204_16349,G__16205_16350));
...
var args__5775__auto__ = [];
var len__5769__auto___16359 = arguments.length;
var i__5770__auto___16361 = (0);
while(true){
if((i__5770__auto___16361 < len__5769__auto___16359)){
args__5775__auto__.push((arguments[i__5770__auto___16361]));

var G__16363 = (i__5770__auto___16361 + (1));
i__5770__auto___16361 = G__16363;
continue;
} else {
}
break;
...
var vec__16238 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16238,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16238,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__16368__delegate = function (add_fmt,add_args){
...
var G__16368 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__16370__i = 0, G__16370__a = new Array(arguments.length -  1);
while (G__16370__i < G__16370__a.length) {G__16370__a[G__16370__i] = arguments[G__16370__i + 1]; ++G__16370__i;}
  add_args = new cljs.core.IndexedSeq(G__16370__a,0,null);
} 
return G__16368__delegate.call(this,add_fmt,add_args);};
G__16368.cljs$lang$maxFixedArity = 1;
G__16368.cljs$lang$applyTo = (function (arglist__16371){
var add_fmt = cljs.core.first(arglist__16371);
var add_args = cljs.core.rest(arglist__16371);
return G__16368__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq16228){
var G__16229 = cljs.core.first(seq16228);
var seq16228__$1 = cljs.core.next(seq16228);
var G__16231 = cljs.core.first(seq16228__$1);
var seq16228__$2 = cljs.core.next(seq16228__$1);
var G__16232 = cljs.core.first(seq16228__$2);
var seq16228__$3 = cljs.core.next(seq16228__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16229,G__16231,G__16232,seq16228__$3);
}));
...
var seq__16249 = cljs.core.seq(features);
var chunk__16250 = null;
var count__16251 = (0);
var i__16252 = (0);
while(true){
if((i__16252 < count__16251)){
var feature = chunk__16250.cljs$core$IIndexed$_nth$arity$2(null,i__16252);
...
var G__16378 = seq__16249;
var G__16379 = chunk__16250;
var G__16380 = count__16251;
var G__16381 = (i__16252 + (1));
seq__16249 = G__16378;
chunk__16250 = G__16379;
count__16251 = G__16380;
i__16252 = G__16381;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__16249);
if(temp__5804__auto__){
var seq__16249__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__16249__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__16249__$1);
var G__16382 = cljs.core.chunk_rest(seq__16249__$1);
var G__16383 = c__5568__auto__;
var G__16384 = cljs.core.count(c__5568__auto__);
var G__16385 = (0);
seq__16249 = G__16382;
chunk__16250 = G__16383;
count__16251 = G__16384;
i__16252 = G__16385;
continue;
} else {
var feature = cljs.core.first(seq__16249__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__16387 = cljs.core.next(seq__16249__$1);
var G__16388 = null;
var G__16389 = (0);
var G__16390 = (0);
seq__16249 = G__16387;
chunk__16250 = G__16388;
count__16251 = G__16389;
i__16252 = G__16390;
continue;
}
} else {
...
var G__16264 = feature;
var G__16264__$1 = (((G__16264 instanceof cljs.core.Keyword))?G__16264.fqn:null);
switch (G__16264__$1) {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o16277 = temp__5802__auto__;
return (o16277["version"]);
} else {
return null;
}
})() == null);
