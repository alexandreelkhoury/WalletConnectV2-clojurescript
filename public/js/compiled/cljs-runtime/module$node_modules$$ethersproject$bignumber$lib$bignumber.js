...
"-"===hex[0]&&(0,bytes_1.isHexString)(hex.substring(1))))return BigNumber.from(hex);return logger.throwArgumentError("invalid BigNumber value","value",value)};BigNumber.isBigNumber=function(value){return!(!value||!value._isBigNumber)};return BigNumber}();exports.BigNumber=BigNumber;exports._base36To16=function(value){return(new BN(value,36)).toString(16)};exports._base16To36=function(value){return(new BN(value,16)).toString(36)}}
